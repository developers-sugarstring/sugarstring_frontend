  ...
  const sidebarItems: SidebarItem[] = [
    {
      ...
      submenu: [...(role === "SuperAdmin" ? [{ title: "Admin Dashboard", href: "/" }] : []), ...(role === "OperationsUser" ? [{ title: "Operations Dashboard", href: "/operations-dashboard" }] : []), ...(role === "ReportingUser" ? [{ title: "Reporting Dashboard", href: "/reporting-dashboard" }] : [])],
    },
    {
      title: "Customers",
      href: "/doctors",
      icon: Users,
      submenu: [
        ...(role !== "ReportingUser" ? [{ title: "Customers List", href: "/customers" }] : []),
        ...(role !== "ReportingUser" ? [{ title: "Add Customer", href: "/customers/add" }] : []),
        ...(role === "ReportingUser" ? [{ title: "Find Customer", href: "/customers/find" }] : []),
        // { title: "Doctor Schedule", href: "/doctors/schedule" },
        // { title: "Specializations", href: "/doctors/specializations" },
        // { title: "Symptoms", href: "/doctors/symptoms" },
      ],
    },
    {
                ...
                <>
                  <button
                    ...
                    className={cn(
                      ...
                      item.href !== "/" && pathname.startsWith(item.href) ? "bg-primary/10 text-primary" : "text-muted-foreground hover:bg-muted hover:text-foreground",
