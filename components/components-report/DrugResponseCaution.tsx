...
export const DrugResponseCaution: React.FC<Props> = ({
  pageIndex,
  totalPages,
  drugs,
  startIndex,
          ...
          {startIndex == 0 && (
            <div className="mt-[10px] gap-4">
              <h3 className="text-[13px] font-semibold tracking-wide">
                DETAILS OF DRUGS TO USE WITH CAUTION
              </h3>
            </div>
          )}
        </div>
              ...
              <div className="flex justify-between">
                <div className="min-w-0 w-full">
                  <div className="flex items-center">
                    ...
                    <div className="ml-auto mr-[35px] flex gap-[6px] flex-wrap" style={{color:"#fff"}}>
...
export default DrugResponseCaution;
